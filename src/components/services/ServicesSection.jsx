  ...
  const services = [
    {
      ...
      image: services1,
      icon: <FaTaxi className="text-black text-3xl group-hover:text-white transition-all duration-500" />,
    },
    {
      id: 2,
      ...
      image: services1,
      icon: <FaBusinessTime className="text-black text-3xl group-hover:text-white transition-all duration-500" />,
    },
    {
      id: 3,
      ...
      image: services1,
      icon: <FaMapMarkedAlt className="text-black text-3xl group-hover:text-white transition-all duration-500" />,
    },
  ];
  ...
  return (
    <div className="container md:w-[85%] mx-auto my-10 grid grid-cols-1 md:grid-cols-3 gap-10">
      {services.map((service) => (
        <div key={service.id} className="shadow-xl max-w-[270px] relative group mx-auto">
          ...
          <div
            ...
            style={{ clipPath: "polygon(12% 15%, 100% 0, 83% 86%, 0% 100%)" }}
          >
            {service.icon}
          </div>
          <div className="p-5">
            <h1 className="text-xl font-bold">{service.title}</h1>
            <p className="text-[12px] my-3 text-gray-400">{service.description}</p>
