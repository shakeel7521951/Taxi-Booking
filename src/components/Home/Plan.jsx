              ...
              <table className="w-full mt-4">
                <tbody>
                  <tr className="border-b">
                    <td className="py-2 text-left text-gray-700 group-hover:text-white">Initial Charge:</td>
                    <td className="py-2 text-right font-semibold text-gray-900 group-hover:text-white">{data.initialCharge}</td>
                  </tr>
                  <tr className="border-b">
                  ...
                  <tr className="border-b">
                    <td className="py-2 text-left text-gray-700 group-hover:text-white">Per Stopped Traffic:</td>
                    <td className="py-2 text-right font-semibold text-gray-900 group-hover:text-white">{data.perStoppedTraffic}</td>
                  </tr>
                  <tr>
